        ...
        <form method="POST" action="{{ route('setAdd') }}" class=" m-5  shadow ">
            ...
            {{-- @if (!empty(session('success')))
                <div class="row backgroundW p-4  ">
                    <div class="alert" style="background-color: #42424a ">
                        <ul>
                            <li style="color:white" class="">{{ session('success') }}</li>
                        </ul>
                    </div>
                </div>
            @endif --}}
            ...
            <div class="row backgroundW p-4  ">
                ...
                <div class="col-md-12 mb-3">
                    <label for="indeed" class="form-labell ">ضمن وسم Head</label>
                    <textarea type="text" id="indeed" name="setHead" class="form-controll resizeForTextarea">@isset($Adds){{ $Adds->atHead }}@endisset</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="top" class="form-labell ">أعلى محتوى الصفحة</label>
                    <textarea type="text" id="top" name="setTop" class="form-controll resizeForTextarea">@isset($Adds){{ $Adds->atTop }}@endisset</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="side" class="form-labell ">منتصف القائمة الجانبية</label>
                    <textarea type="text" id="side" name="setCenter" class="form-controll resizeForTextarea">@isset($Adds){{ $Adds->atRight }}@endisset</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="more" class="form-labell ">في المزيد من الاختبارات</label>
                    <textarea type="text" id="more" name="otherSite" class="form-controll resizeForTextarea">@isset($Adds){{ $Adds->otherSite }}@endisset</textarea>
                </div>
                <div class="col-12">
